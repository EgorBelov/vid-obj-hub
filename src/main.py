...
from src.bot.handlers.search_by_image import start_img_search, handle_photo_query
...
from src.bot.handlers.video import handle_video, start_video
...
async def main():
    ...
    dp.message.register(start_video, F.text == "Загрузить видео")
    ...
    dp.message.register(start_img_search, F.text == "Поиск по изображению")
    dp.message.register(handle_photo_query, F.photo)         # фото для поиска
